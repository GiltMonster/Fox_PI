...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (empty($id)) { //se o id estiver vazio
        ...
        try {
            $stmt = $pdo->prepare("DELETE FROM ADMINISTRADOR WHERE ADM_ID = :id"); //consulta SQL no banco 
            ...
            if ($stmt->rowCount() > 0) { //se retornar algum registro
                ...
                header('Location: listar_administrador.php'); //redireciona para a página listar_produtos.php
            } else {
