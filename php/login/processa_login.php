...
$sql = "SELECT ADMINISTRADOR.ADM_ID, ADMINISTRADOR.ADM_NOME, ADMINISTRADOR.ADM_EMAIL, ADMINISTRADOR.ADM_ATIVO FROM ADMINISTRADOR WHERE ADM_EMAIL = :adm_email AND ADM_SENHA = :adm_senha"; //consulta SQL
