...
<body>
    <main>
        <form class="form_main" action="../../php/login/processa_login.php" method="post">
            <img class="heading" src="../../images/fox.svg" />
            ...
            <div class="inputContainer">
                ...
                <input class="inputField" placeholder="E-mail" type="email" id="adm_email" name="adm_email" required>
            </div>
