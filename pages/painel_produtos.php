...
<head>
    ...
    <link rel="stylesheet" href="../style/painel_produto.css">
...
<body>
    <section>
        ...
        <section class="container">
            ...
            <p>Este é o painel de Produtos.</p>
            <p>Aqui você pode:</p>
            <div class="container-buttons">
                <a class="btn-produto" href="../pages/CadastrarProdutos.php">
                ...
                <a class="btn-produto" href="../php/listar_produtos.php">
