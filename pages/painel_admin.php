...
<head>
    ...
    <link rel="stylesheet" href="../style/painel_admin.css">
...
<body>
    ...
    <main>
        <section class="container">
            ...
            <p>Este é o painel de administração.</p>
            <p>Aqui você pode:</p>
            <div class="container-buttons">
                <a class="btn-admin" href="../pages/cadastrar_administrador.php">
                ...
                <a class="btn-admin" href="../php/listar_administrador.php">
